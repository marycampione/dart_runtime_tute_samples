...
abstract class ModelDescription {
  ...
  rawDatastore.Entity encodeModel(ModelDB db, Model model) {
    ...
    return new rawDatastore.Entity(
  ...
  Model decodeEntity(ModelDB db, Key key, rawDatastore.Entity entity) {
  ...
  _decodeProperty(ModelDB db, rawDatastore.Entity entity,
...
abstract class ExpandoModelDescription extends ModelDescription {
  ...
  rawDatastore.Entity encodeModel(ModelDB db, ExpandoModel model) {
    List stateVector =  db.modelDescriptionState(this);
